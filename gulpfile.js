...
var createJS = function (options) {
    ...
    var file_name = (options.dev) ? 'netsageBumpChart_' + name_lower + '.js' : 'netsageBumpChart_' + name_lower + '.min.js';
...
var createCSS = function (options) {
    ...
    var file_name = (options.dev) ? 'netsageBumpChart_' + name_lower + '.css' : 'netsageBumpChart_' + name_lower + '.min.css';
...
var _generateYuiAPIDocs = function (options) {
    ...
    return gulp.src("./js/**/*.js")
        .pipe(yuidoc.parser({
            project: {
                "name": "Netsage Bump Chart",
                "description": "Netsage Bump Chart API ",
                "version": "1.0.3",
